    ...
    <div class="Agenda">
        ...
        ?>
                <p>
                    ...
                    <span><?= $i['placa'] ?></span>
<<<<<<< HEAD
                    <a href="../Instrutor/editar.php?idCarro=<?= $i['id'] ?>"><img style="margin-left: 20%;" src="../Imgs/icoCarro.png" alt="iconeCarro" class="iconeNav"></a>
=======
...
>>>>>>> 6e8ddaf2187692e485847091588814a26cbf9110
